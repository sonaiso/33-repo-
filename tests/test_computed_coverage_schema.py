...
FORBIDDEN_COMPUTED_VERDICT_VALUE = "FORBIDDEN_COMPUTED"
...
def test_schema_rejects_computed_verdict():
    _assert_invalid(
        _minimal_valid_case() | {"computed_verdict": FORBIDDEN_COMPUTED_VERDICT_VALUE}
    )
...
def test_schema_rejects_computed_verdict_for_every_expected_verdict(verdict: str):
    _assert_invalid(
        ...
        | {"computed_verdict": FORBIDDEN_COMPUTED_VERDICT_VALUE}
    )
