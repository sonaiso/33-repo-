...
| الطبقة | الدور في التدقيق | ليست غاية بل وسيلة لـ |
|--------|------------------|----------------------|
| L0 (لغة موضوعية) | تفكيك بنية إجابة GPT إلى كيانات أساسية | توفير المادة الخام للتحليل |
| L1 (وصف رسمي) | تعريف معايير المعقولية (ما الذي يجعل إجابة معقولة؟) | بناء القاموس الدستوري المرجعي |
| L2 (منطق واستدلال) | مقارنة إجابة GPT بالمعايير المرجعية (هل تتطابق؟) | محرك مقارنة وقياس |
| L3 (واقع وتطبيق) | إصدار حكم نهائي على المعقولية | الحكم: معقول / غير معقول / معلّق |
