...
Origin: docs/00_MAQOOL_CONSTITUTION.md §9 (Common Notions)
Authority: docs/15_PROJECT_ROADMAP.md Phase 1 PR-B

=== Constitutional Common Notions (CN1-CN4) ===

CN1 — Self-Equality (المساواة الذاتية)
CN2 — Whole Greater Than Part (الكل أكبر من الجزء)
CN3 — Substitution (الاستبدال)
CN4 — Transitivity of Subsumption (تعدّي الاشتمال)
"""
...
class CommonNotionDomain(str, Enum):
    ...
    Origin: docs/00_MAQOOL_CONSTITUTION.md §9
...
class CommonNotion:
    ...
    order : int
        Canonical constitutional order (1..4).
